...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
uint8_t TIMER_to_scan_Cnt;
uint8_t AD_scan_index=0;
int AD1_DATA[5],AD2_DATA[5],AD3_DATA[5],AD4_DATA[5],average_int=0;
/* USER CODE END PM */
...
/*	AD7124Init(&hspi2);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		if(TIMER_to_scan_Cnt>100)
		{
			TIMER_to_scan_Cnt = 0;
			//scan_ad7124_channel(&hspi1,0,AD1_DATA);
			AD7124Init(&hspi1,0);
		}	
  }
  /* USER CODE END 3 */
